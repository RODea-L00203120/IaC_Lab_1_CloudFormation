...
While logs are output to terminal, for readability Cloudwatch is preferable; so deploy live, invoke to generate logs and you can view them in the AWS console interface online. 
